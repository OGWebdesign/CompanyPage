    ...
    <div className="w-full flex justify-center">
     ...
     <div className="w-full mobile:p-2 tablet:px-5 bg-[#151515] flex justify-center items-center">
      ...
      <div className="w-full grid gap-11 mobile:gap-20  mobile:grid-rows-4 mobile:grid-cols-1 tablet:grid-cols-1 tablet:grid-rows-2 desktop:grid-rows-1 desktop:grid-cols-2 place-content-center place-items-center mt-20 mb-[10%]">
        ...
        <CardWhite classname="tablet:translate-x-20" text1="Webdesign &" text2="programming" description="50% of website visitors leave after a loading time of 3 seconds. Be the owner of a website that finishes loading in 200ms."></CardWhite>
        <CardWhite classname="tablet:-translate-x-20" text1="Consulting &" text2="administration" description="Even if you need advice on your content management system, we advise you or administer your existing website."></CardWhite>
