          ...
          <div className="mobile:w-full tablet:w-full desktop:w-[55%] desktop-xl:w-[45%]">
            ...
            <div className="w-full flex justify-center items-center">
              <div className="desktop:w-[100%] desktop-xl:w-[75%]  grid gap-11 mobile:gap-20  mobile:grid-rows-4 mobile:grid-cols-1 tablet:grid-cols-1 tablet:grid-rows-2 desktop:grid-rows-1 desktop:grid-cols-2 place-content-center place-items-center mt-20 mb-[5%]">
                ...
                <CardWhite classname="tablet:translate-x-20" text1="Webdesign &" text2="programming" description="50% of website visitors leave by a loading time of 3 seconds. We build website that finishes loading in 200ms."></CardWhite>
                <CardWhite classname="tablet:-translate-x-20" text1="Consulting &" text2="administration" description="If you need advice on your CMS, we advise or administer your existing website."></CardWhite>
