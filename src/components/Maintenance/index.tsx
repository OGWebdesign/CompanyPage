    ...
    return (
        <div className="w-full h-screen animate-fadeIn cursor-none flex items-center  justify-center flex-col z-10 bg-black">
            <div className="flex flex-col mobile:p-10">
                ...
                <p className="text-white w-[25rem] font-mono text-[1rem]">Unsere Website befindet sich gerade in der Wartung im Bereich Hilfecenter, um Ihnen eine noch bessere Nutzererfahrung zu bieten. Wir arbeiten intensiv daran, neue Features zu integrieren und bestehende Funktionen zu optimieren. Wieder verfügbar: 3. Oktober 2024</p>
                {props.children}
