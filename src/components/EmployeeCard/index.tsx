  ...
  return (
    <div className="w-full flex justify-center items-center">
      <div className="w-full desktop:max-w-[100rem] items-center flex flex-col cursor-none duration-300  rounded-2xl p-6 justify-center font-mono border-white">
        {/* Left Side */}
        <div className="w-[60%] flex tablet:flex-row group mobile:justify-center mobile:items-center mobile:flex-col-reverse mt-[10%] duration-500">
          <div className="text-slate-200">
            <p className="font-mono font-bold text-[3rem] text-[#98f144] ">
              Hi, I'm Nils.
            </p>
            <motion.p className="text-[1.2rem] mt-[1.5rem]">
        ...
        {/* Right Side */}
        <div className="w-[60%] flex tablet:flex-row group mobile:flex-col mobile:justify-center mobile:items-center duration-500 mt-[10%]">
          <div className="">
            {/** ------------------------------PLACE KOSMONAUT HERE------------------------------ */}
          </div>
          <div className="text-slate-200">
            ...
            <motion.p className="text-[1.2rem] mt-[1.5rem]">
              ...
              experience in web applications and frontend development, but I am
              also familiar with bot networks and interfaces for artificial
