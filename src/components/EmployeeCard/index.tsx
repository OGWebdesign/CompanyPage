        ...
        <div className="w-full flex cursor-none justify-center font-mono  bg-[#151515] gap-20 mt-[5%] border-white">
            ...
            <div className="w-1/2 h-full flex flex-col justify-around group">
                <div className="flex items-end flex-col text-right">
                    <img src="nils.png" className="w-[10rem] h-[10rem] bg-nils hover:scale-125 duration-300 hover:border-8 grayscale hover:grayscale-0  hover:border-[#98f144] rounded-full border-slate-200 border-2 bg-no-repeat bg-cover">
            ...
            <div className="w-1/2 h-full flex flex-col group">
                <img src="max.png" className="w-[10rem] h-[10rem] bg-nils hover:scale-125 duration-300 hover:border-8 grayscale hover:grayscale-0  hover:border-[#98f144] rounded-full border-slate-200 border-2 bg-no-repeat bg-cover">
