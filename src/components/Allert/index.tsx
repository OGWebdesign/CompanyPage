export const Allert = () => {
    return (
        <div className="w-[100%] h-[5rem] mobile:my-[30%] tablet:my-[20%] desktop:my-[5%] flex justify-center items-center">
            ...
            <div className="w-2/3">
                <p className="ml-10 font-mono select-none  text-[#777777] text-[1rem]">At our digital marketing agency, we offer a range of services to help businesses grow and succeed online. These services inlude:</p>
            </div>
        </div>
    )
}