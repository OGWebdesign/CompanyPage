...
export const ContactSite = () => {
    return (
        <div className="w-full flex justify-center items-center">
            ...
            <img src="Planets/icePlanet.webp" alt="" className="w-[40rem] absolute desktop:top-[10%] desktop:right-[10%] laptop:top-[10%] laptop:right-[0%] mobile:top-[50%] animate-floatIcePlanet"/>

            <img src="/graphics/astro.webp" alt="" className="w-[20rem] absolute z-10 mobile:bottom-[-20%] mobile:right-[-15%] tablet:bottom-[-10%] tablet:right-[10%] animate-float" />
