    ...
    return (
        ...
        <div className="w-full duration-500 flex flex-col ">
            ...
            <div className={`w-full mobile:opacity-100 tablet:opacity-100 desktop:opacity-0 desktop:h-0 flex flex-col justify-center items-center ${visible ? visibleStyle : notVisibleStyle} duration-300 bg-[#202020]`}>
                {/* Croll Bar Item I */}
                <a className={`my-5 ${bordervisibility} text-[#747474] w-[15rem] text-center font-mono font-bold text-[1.2rem] hover:text-[#98f144] hover:animate-ownpulse border-[#202020] border-2 hover:border-[#98f144] rounded-lg overflow-hidden`}
                    href="/">Start</a>
                {/* Croll Bar Item II */}
                <a className={`my-5 ${bordervisibility} text-[#747474] w-[15rem] text-center  font-mono font-bold text-[1.2rem] hover:text-[#98f144] hover:animate-ownpulse border-[#202020] border-2 hover:border-[#98f144] rounded-lg overflow-hidden`}
                    href="/">Company</a>
