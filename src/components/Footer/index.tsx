            ...
            <div className="w-full cursor-none flex flex-col border font-mono text-slate-200 p-10 mobile:p-4 bg-slate-200 mobile:rounded-t-xl rounded-t-2xl mt-[10%]">
                ...
                <div className="w-full cursor-none flex font-mono font-semibold text-[#151515] mt-[3%] duration-300  items-center tablet:text-[1rem] mobile:text-[0.8rem]">
                    <div className="w-1/2 flex desktop:gap-10 tablet:gap-6 mobile:gap-4 justify-start" >
                        <a className="inline-block hover:bg-[#98f144] cursor-none duration-300 hover:font-bold" href="">Imprint</a>
                        <a className="inline-block hover:bg-[#98f144] cursor-none duration-300 hover:font-bold" href="">Privacy</a>
                        <a className="inline-block hover:bg-[#98f144] cursor-none duration-300 hover:font-bold" href="/contact">Contact</a>
                        <a className="inline-block hover:bg-[#98f144] cursor-none duration-300 hover:font-bold" href="/contact">Offer</a>
                    </div>
