...
export const CardWhite = (props:{
    ...
    return(
        <div className={`w-full ${props.classname}  max-w-[30rem] min-w-[25rem] p-5 h-[15rem] border rounded-2xl flex border-b-8 bg-slate-200`}>
            ...
            <div className="flex flex-col w-1/2">
                ...
                <div className="w-full h-1/2 flex justify-center items-center">
                    <div className="w-[8rem] group h-12 rounded-xl hover:cursor-pointer border-2 border-slate-200 duration-300 group hover:border-[#151515] bg-[#151515] hover:bg-[#98f144] flex justify-center items-center">
                        ...
                        <ArrowIcon className="w-6 h-6 fill-slate-200 duration-300 group-hover:translate-x-14 group-hover:fill-black  "></ArrowIcon>        
                    </div>
                </div>
            </div>
