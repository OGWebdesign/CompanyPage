        ...
        <div className={`w-full ${props.classname} select-none  max-w-[30rem] min-w-[25rem] p-5 h-[15rem] border rounded-2xl flex border-b-8 bg-slate-200`}>
            ...
            <div className="flex flex-col">
                ...
                <div className="mobile:p-2 p-4 w-full h-1/2 text-[#151515]">
                    ...
                    <article className="h-full mt-[1rem]  duration-300 text-[0.95rem] tablet:text-[1rem] mobile:text-[0.9rem] desktop:text-[1rem] p-3 flex items-center font-mono font-semibold">
                    {props.description}
                </article>
                </div>
                {props.children}
