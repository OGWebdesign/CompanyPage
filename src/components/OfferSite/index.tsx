...
export const OfferSite = () => {
  ...
  const borderGreenDashed =
    "border-dashed border-[#98f144] border-2 duration-500";

  const clickEffect = "bg-[#c5c5c5] shadow-[5px_5px_0px_0px_rgba(152,241,68)]";

  const notClicked =
    "hover:bg-[#c5c5c5] hover:shadow-[5px_5px_0px_0px_rgba(152,241,68)]";
  ...
  return (
    <div className="w-full h-full flex flex-col items-center">
      <img
        ...
        className="w-[40rem] z-10 absolute top-[35%] right-[10%] animate-floatJupiter"
        alt="sun"
      />
      <img
        src="Planets/spacestation.webp"
        className="laptop:w-[20rem] mobile:w-[10rem] tablet:w-[15rem] z-10 absolute laptop:bottom-[-10%] laptop:left-[5%] mobile:bottom-[-10%] mobile:right-[5%] animate-float"
        alt="spacestation"
      />

      {/* SUCCESS WINDOW*/}
      <div
        className={`w-[45rem] h-[15rem] bg-[#000000]  font-sharemono absolute bottom-[10%] ${
          sendSuccess ? "animate-flyoffscreen block" : "hidden"
        } ${
          firstAnimation ? "animate-fadeIn" : ""
        } z-50 flex justify-center items-center rounded-xl`}
      >
      ...
      <div className=" desktop:w-full desktop-l:w-[80%] mobile:w-full flex flex-col justify-center items-center z-30">
        <div className="flex mobile:flex-col laptop:flex-row justify-around w-3/4">
            ...
            <div className="p-1">
              <div className="offertext tablet:mt-[10%] max-w-[40rem]">
                ...
                <p className="text-white mt-[2%] mobile:mt-[10%] text-[1.4rem] mobile:text-[1rem] font-sharemono">
                  Lernen Sie uns und unsere Arbeit in einem unverbindlichen
                  Erstgespräch kennen und erzählen Sie uns Ihr Projekt im
                  Detail.
                </p>
                <p className="text-[#8f8f8f] mt-[2%] text-[1.4rem] mobile:mt-[10%] mobile:text-[1rem] font-sharemono">
                  Erstellen Sie einfach eine Projektanfrage und geben Sie uns
                  einige Details zu Ihrem Anliegen. Gemeinsam werden wir Ihre
                  Probleme lösen und Ihr Unternehmen auf die nächste Stufe der
                  digitalen Welt bringen. Ich freue mich, Sie und Ihr Projekt
                  kennenzulernen.
                </p>
          ...
          <div className="w-full laptop:h-[50rem] laptop:mt-24 desktop-l:mt-[20%] laptop:m-0 mobile:mt-[5rem] flex items-center flex-col">
            <img
              className="h-[20rem] mobile:h-[15rem] animate-flyIn"
              src="graphics\astro.webp"
              alt="a little cute astronaut"
              onAnimationEnd={(e) => {
            ...
            <div className="w-full flex flex-col items-center">
              <div className="w-full flex tablet:justify-evenly gap-4 mobile:justify-between items-center">
                <div
                  ...
                  className={`${
                    noTechSelected ? borderDashed : borderGreenDashed
                  }  tablet:w-[6rem] tablet:h-[6rem] mobile:w-[5rem] mobile:h-[5rem] ${
                    select1 ? clickEffect : notClicked
                  }  group duration-500 transition-all eas flex flex-col justify-center items-center rounded-xl`}
                >
                  <div
                    className={`flex justify-center items-center group-hover:fill-black duration-500 ${
                      select1 ? "fill-black" : "fill-white"
                    } `}
                  >
                    <CodeIcon
                      className={`mobile:w-[2rem] mobile:h-[2rem] tablet:w-[2.5rem] tablet:h-[2.5rem]`}
                    />
                  </div>
                  <div
                    className={`w-full text-center mobile:text-[0.8rem] tablet:text-[1rem] mt-[0.3rem] font-sharemono group-hover:text-black duration-500 ${
                      select1 ? "text-black" : "text-white"
                    }`}
                  >
                    <p>Webseiten</p>
                  </div>
                ...
                <div
                  ...
                  className={`${
                    ...
                    select2 ? clickEffect : notClicked
                  }  group duration-500 transition-all eas flex flex-col justify-center items-center rounded-xl`}
                >
                  <div
                    className={`flex justify-center items-center group-hover:fill-black duration-500 ${
                      select2 ? "fill-black" : "fill-white"
                    } `}
                  >
                ...
                <div
                  ...
                  className={`${
                    ...
                    select3 ? clickEffect : notClicked
                  }  group duration-500 transition-all eas flex flex-col justify-center items-center rounded-xl`}
                >
                  <div
                    className={`flex justify-center items-center group-hover:fill-black duration-500 ${
                      select3 ? "fill-black" : "fill-white"
                    } `}
                  >
                ...
                <div
                  ...
                  className={`${
                    ...
                    select4 ? clickEffect : notClicked
                  }  group duration-500 transition-all eas flex flex-col justify-center items-center rounded-xl`}
                >
                  <div
                    className={`flex justify-center items-center group-hover:fill-black duration-500 ${
                      select4 ? "fill-black" : "fill-white"
                    } `}
                  >
              ...
              {noTechSelected && (
                <span className="text-red-500 text-[1.1rem] mt-[2rem] font-sharemono animate-fadeIn duration-300">
              ...
              <div
                className={`w-full flex justify-evenly items-center mt-[4rem] `}
              >
                <span
                  onClick={() => {
                    setSelect100(true);
                  ...
                  className={` font-sharemono text-[1.1rem] p-5 rounded-xl hover:text-black duration-300 ${
                    select100
                      ? clickEffect + " text-black"
                      : notClicked + " text-white"
                  }`}
                >
                  100€
                </span>
              ...
              <div
                className={`w-[65%] h-[3rem] mobile:w-full bg-[#151515] mt-[2rem]  flex justify-between items-center rounded-xl  `}
              >
                <div
                  onClick={() => {
                    decrease_sound.play();
                ...
                <span
                  className={` font-sharemono text-[1.3rem] ${
                    underborder ? "text-red-500" : "text-[#98f144]"
                  }`}
                >
                  {price}€
                </span>
              ...
              <span
                className={`mt-[1rem] font-sharemono ${
                  price < 500 ? "text-red-500" : "text-white"
                } `}
              >
                {price < 500
                  ? "Gute Arbeit erfordert seinen Preis!"
                  : "Ihr Budget"}
              </span>
            </div>
          </div>
  ...
  font-mono"
          >
            <h1
              className={`text-white mobile:text-[2rem] tablet:text-[2.3rem] laptop:text-[3rem] mobile:ml-[4rem] laptop:ml-[15rem] font-bold font-mono transition-all duration-700 ease-in-out ${
                check && "-translate-y-14"
              }`}
            >
              HELLO,
            </h1>
        ...
        leading-none"
                >
                  MY{" "}
                  <span
                    className={` text-[#151515] duration-300 ${
                      noEmail ? "bg-red-500" : "bg-[#98f144]"
                    }`}
                  >
                    MAIL
                  </span>{" "}
        ...
        mobile:w-full tablet:mr-[2rem] tablet-contact:mr-[5.5rem] laptop:mr-[6rem] laptop:w-[50rem] desktop:w-[60rem]
         ...
         text-center bg-[#151515] text-[#98f144] border-b-2 leading-none
        placeholder-[#777777] flex justify-center items-center duration-300 ${
          noEmail ? "border-red-500" : ""
        } `}
                  required
                  onChange={(e: React.FormEvent<HTMLInputElement>) => {
                    if (e.currentTarget.value) {
        ...
        leading-none"
                >
                  MY <span className="bg-[#98f144] text-[#151515]">FIRM</span>{" "}
                  IS{" "}
                </span>
        ...
        placeholder-[#777777] flex justify-center items-center duration-300 ${
          noPhone ? "border-red-500" : ""
              ...
              {/* MY MESSAGE IS.. */}
              <div
                className={`w-full flex flex-col mt-5 transition-all duration-700 ease-in-out `}
              >
                <span
                  className={`text-white 
          ...
          leading-none ${
            check && "-translate-y-14"
                ...
                >
                  ...
                  <span
                    className={` text-[#151515] duration-300 ${
                      noMessage ? "bg-red-500" : "bg-[#98f144]"
                    }`}
                  >
                    MESSAGE
                  </span>{" "}
        ...
        placeholder-[#777777] transition-all duration-700 ease-in-out p-2  ${
          check && "-translate-y-14"
        } ${hTextBox && "h-[8rem]"}
      ...
      hover:bg-[#6ba039] cursor-none font-mono transition duration-700 ease-in-out ${
        check && "-translate-y-12"
      }`}
              >
