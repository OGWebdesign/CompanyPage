...
export const PriceCardWebApp = (props: PriceCardProps) => {

    {/* Preiskonstanten */}
    {/* ONE PAGER */}
    const miniAppPrice = 1750;
    {/* START UP */}
    const mediumApp6to8weeks = 3700;
    const mediumApp8to10weeks = 3500;
    const mediumApp10to12weeks = 3300;
    {/* BUSINESS */}
    const LargeApp6to8weeks = 6000;
    const LargeApp8to10weeks = 5800;
    const LargeApp10to12weeks = 5600;
    ...
    */}
    const price = (weeksSelected : number | undefined, packageSelected : number | undefined) : number | undefined => {
        switch(packageSelected){
            ...
            case 2 : 
                {/* 6-8 Wochen */}
                if (weeksSelected === 1){
                    return mediumApp6to8weeks;
                } 
                /* 8-10 Wochen */
                else if (weeksSelected === 2){
                    return mediumApp8to10weeks;
                }
                /* 10-12 Wochen */
                else if (weeksSelected === 3){
                    return mediumApp10to12weeks;
                }
            break;
            {/* Business Package */}
            case 3 :
                 {/* 6-8 Wochen */}
                 if (weeksSelected === 1){
                    return LargeApp6to8weeks;
                 } 
                 /* 8-10 Wochen */
                 else if (weeksSelected === 2){
                    return LargeApp8to10weeks;
                 }
                 /* 10-12 Wochen */
                 else if (weeksSelected === 3){
                    return LargeApp10to12weeks;
                 }
             break;
            default:
                return 0;
    ...
    {/* Funktion für Punkt beim Preis */}
    function priceDot(priceActual: number | undefined) {
    ...
    return (
        ...
        <div className="w-[25rem] flex flex-col justify-center items-center bg-slate-200 mt-[5rem] px-10 py-3 font-mono rounded-xl">
            ...
            {/* DESCRIPTION */}
            <p className="text-[0.7rem] w-[15rem] text-center">
                An imprint brand is a reference to us and it is explicitly mentioned that OG-Webdesign created this App.
            </p>
